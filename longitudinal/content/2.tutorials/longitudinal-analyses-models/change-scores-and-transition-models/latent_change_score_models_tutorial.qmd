...
Latent Change Score Models (LCSM) are an extension of traditional latent growth models, designed to explicitly model the change between consecutive time points. LCSMs focus on how much individuals change over time and the factors that drive this change. By modeling the latent change directly, LCSMs allow researchers to assess what influences growth rates and explore individual differences in the change process.

LCSM is particularly useful for researchers who are interested in understanding how change occurs over time and what variables may predict this change.
