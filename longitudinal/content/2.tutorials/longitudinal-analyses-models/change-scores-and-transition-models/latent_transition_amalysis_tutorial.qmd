...
Latent Transition Analysis (LTA) is a longitudinal extension of latent class analysis (LCA) that models changes in latent class membership over time. LTA identifies distinct subgroups (latent classes) at different time points and tracks transitions between these classes. It is particularly useful for understanding how individuals move between latent states (e.g., risk levels, behavioral profiles) over time and what factors influence these transitions.

LTA is ideal for researchers interested in exploring shifts in behavioral or psychological states and understanding how transitions are influenced by covariates.
